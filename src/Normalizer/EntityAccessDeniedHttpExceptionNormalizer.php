 ...
 */
class EntityAccessDeniedHttpExceptionNormalizer extends JsonApiEntityAccessDeniedHttpExceptionNormalizer {
    ...
    if ($exception instanceof EntityAccessDeniedHttpException) {
      ...
      if (isset($entity)) {
        ...
        $route_name = !is_null($relationship_field)
          ? "fusion.$resource_type_name.$relationship_field.related"
          : "fusion.$resource_type_name.individual";
